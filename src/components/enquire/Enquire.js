        ...
        <div>
            <section id='section-3'>
                <div className='priceTitle'>
                    ...
                    <h4 className='subTop'>Fill in the form below to start your journey to doubling your beauty
                    </h4>
                </div>
            </section>
            <section>
                <div className='form-container center'>
                    <form className='tertiary form'>
                        ...
                        <div>
                            <ul>
                                ...
                                <li>Dermal Fillers<img src={arrow} alt='arrow' />
                                ...
                                <li>Areas Available<img src={arrow} alt='arrow' />
                                    <ul>
                                        <li>
                                ...
                                <li>Available Treatments<img src={arrow} alt='arrow' />
                                    <ul>
                                        <li>
                                ...
                                <li>Other Treatments<img src={arrow} alt='arrow' />
                                    <ul>
                                        <li>
                                ...
                                <li>Anti Wrinkle Treatment<img src={arrow} alt='arrow' />
                                    <ul>
                                        <li>
                                ...
                                <li>Beauty<img src={arrow} alt='arrow' />
                                    <ul>
                                        <li>
